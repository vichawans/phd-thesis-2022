...
\subsection{Aerosol and Climate} %Section - 1.1 
...
\subsection{Quantifying role of aerosol on climate}
...
\subsubsection{\ce{SO2} primary emission}
...
\subsubsection{\ce{SO2} deposition}
...
\subsubsection{Other sources of sulfur and secondary emission of \ce{SO2}}
\label{ch1:other-so2}
...
\subsection{Global tropospheric sulfate aerosol chemical modelling} %Section - 1.2
\label{section1.2}
...
\subsubsection{State of the science in sulfur modelling}
...
\subsection{Contribution to aerosol-climate modelling}
